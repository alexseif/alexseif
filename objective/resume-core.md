---
name: "Alex Seif"
title: "Systems Architect & Technical Partner"
email: "alex.seif@gmail.com"
phone: "+201004006332"
location: "Cairo, Egypt (Open to relocation/sponsorship)"
...
## Technical Partner & Principal Architect | Independent Consultancy
### 2014 – Present
- **SASO Platform Integration:** Engineered a high-security multi-phase form orchestration engine and background state machine. Successfully converted manual public sector workflows into automated, contactless pipelines processing transactional updates under evolving compliance rules.
- **Data Forensic Remediation (NSCE):** Resolved critical architectural bottlenecks for a cross-border multi-lingual database. Normalized fractured legacy relational schemas, built highly indexed search engines, and integrated geospatial mapping nodes utilized by institutional donors (UN, GIZ, EU).
