...
class __TwigTemplate_00f5dd41a885c9055f2a09199be1f202 extends Template
{
    ...
    public function block_content(array $context, array $blocks = []): iterable
    {
        ...
        $context['_seq'] = CoreExtension::ensureTraversable(($context["portfolios"] ?? null));
        foreach ($context['_seq'] as $context["_key"] => $context["portfolio"]) {
            // line 12
            yield "                        <div class=\"d-flex mb-5 bg-black portfolio-item\">
                            <img src=\"";
            // line 13
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["portfolio"], "image", [], "any", false, false, false, 13), "html", null, true);
            yield "\" class=\"img-fluid\" alt=\"";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["portfolio"], "title", [], "any", false, false, false, 13), "html", null, true);
            yield "\"/>
                            <div class=\"m-4 bg-dark flex-fill\">
                                <h3 class=\"bg-black pb-2\">";
            // line 15
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["portfolio"], "title", [], "any", false, false, false, 15), "html", null, true);
            yield "</h3>
                                <div class=\"p-1\">
                                    <p>";
            // line 17
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["portfolio"], "description", [], "any", false, false, false, 17), "html", null, true);
            yield "</p>
                                </div>
                            </div>
                        </div>
        ...
        unset($context['_seq'], $context['_key'], $context['portfolio'], $context['_parent']);
...
";
    ...
    {
        return new Source("", "portfolio/index.html.twig", "/var/www/alexseif/templates/portfolio/index.html.twig");
    }
}
