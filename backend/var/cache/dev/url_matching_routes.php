    ...
    [ // $regexpList
        0 => '{^(?'
                ...
                .'|/_(?'
                    ...
                    .')'
                .')'
                .'|/(en|ar|eg)/wordpress\\-optimization(*:380)'
            .')/?$}sDu',
    ],
    [ // $dynamicRoutes
        ...
        240 => [[['_route' => '_profiler_font', '_controller' => 'web_profiler.controller.profiler::fontAction'], ['fontName'], null, null, false, false, null]],
