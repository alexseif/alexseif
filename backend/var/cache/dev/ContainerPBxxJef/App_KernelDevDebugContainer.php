...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\Admin\\IntakeFormSubmissionCrudController' => 'getIntakeFormSubmissionCrudControllerService',
            ...
            'App\\Controller\\ExperimentsController' => 'getExperimentsControllerService',
            ...
            'App\\Controller\\MindfulnessController' => 'getMindfulnessControllerService',
            ...
            'Vich\\UploaderBundle\\Naming\\SmartUniqueNamer.portfolio_image' => 'getSmartUniqueNamer_PortfolioImageService',
        ...
        $this->privates['service_container'] = static function ($container) {
            ...
            include_once \dirname(__DIR__, 4).'/src/Twig/RtlExtension.php';
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('jxwdc8wdEz', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        return $container->services['cache.easyadmin'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('h1P89WXtG4', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.security_is_granted_attribute_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('4f2Ga43Vif', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('SWv5kD83Dw', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('TT9YLhpqrf', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected static function getDoctrine_Orm_DefaultEntityManagerService($container, $lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Repository\\InageRepository' => ['privates', 'App\\Repository\\InageRepository', 'getInageRepositoryService', true],
            'App\\Repository\\IntakeFormSubmissionRepository' => ['privates', 'App\\Repository\\IntakeFormSubmissionRepository', 'getIntakeFormSubmissionRepositoryService', true],
            'App\\Repository\\UserRepository' => ['privates', 'App\\Repository\\UserRepository', 'getUserRepositoryService', true],
        ], [
            'App\\Repository\\InageRepository' => '?',
    ...
    protected static function getAdminRouterSubscriberService($container)
    {
        ...
        $d = new \EasyCorp\Bundle\EasyAdminBundle\Registry\CrudControllerRegistry(['App\\Controller\\Admin\\IntakeFormSubmissionCrudController' => 'App\\Entity\\IntakeFormSubmission', 'App\\Controller\\Admin\\UserCrudController' => 'App\\Entity\\User'], ['App\\Controller\\Admin\\IntakeFormSubmissionCrudController' => '8a464a2', 'App\\Controller\\Admin\\UserCrudController' => 'c92e0af'], ['App\\Entity\\IntakeFormSubmission' => 'App\\Controller\\Admin\\IntakeFormSubmissionCrudController', 'App\\Entity\\User' => 'App\\Controller\\Admin\\UserCrudController'], ['8a464a2' => 'App\\Controller\\Admin\\IntakeFormSubmissionCrudController', 'c92e0af' => 'App\\Controller\\Admin\\UserCrudController']);
    ...
    protected static function getAdminRouteGeneratorService($container)
    {
        return $container->privates['EasyCorp\\Bundle\\EasyAdminBundle\\Router\\AdminRouteGenerator'] = new \EasyCorp\Bundle\EasyAdminBundle\Router\AdminRouteGenerator(new RewindableGenerator(function () use ($container) {
            ...
            yield 0 => ($container->services['App\\Controller\\Admin\\IntakeFormSubmissionCrudController'] ?? $container->load('getIntakeFormSubmissionCrudControllerService'));
    ...
    {
        return $container->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('jBXXTF829-', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('-WPg55JSlv', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    ...
    {
        return $container->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('CjvnXCxKvR', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('gUMx+RfSwx', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('6OtI4-OAlb', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.ux.twig_component'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('vUPapr9Jah', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('fsMKpPO+Rd', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.webpack_encore'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('d8Nx6r8+BS', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected static function getDebug_ControllerResolverService($container)
    {
        ...
        $a->allowControllers(['App\\Kernel', 'App\\Controller\\Admin\\DashboardController', 'App\\Controller\\Admin\\IntakeFormSubmissionCrudController', 'App\\Controller\\Admin\\UserCrudController', 'App\\Controller\\DefaultController', 'App\\Controller\\ExperimentsController', 'App\\Controller\\HomeController', 'App\\Controller\\LandingPageController', 'App\\Controller\\MindfulnessController', 'App\\Controller\\SecurityController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    protected static function getDoctrine_Dbal_DefaultConnection_EventManagerService($container)
    {
        return $container->privates['doctrine.dbal.default_connection.event_manager'] = new \Symfony\Bridge\Doctrine\ContainerAwareEventManager(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'vich_uploader.listener.clean.portfolio_image' => ['privates', 'vich_uploader.listener.clean.portfolio_image', 'getVichUploader_Listener_Clean_PortfolioImageService', true],
            'vich_uploader.listener.remove.portfolio_image' => ['privates', 'vich_uploader.listener.remove.portfolio_image', 'getVichUploader_Listener_Remove_PortfolioImageService', true],
            'vich_uploader.listener.upload.portfolio_image' => ['privates', 'vich_uploader.listener.upload.portfolio_image', 'getVichUploader_Listener_Upload_PortfolioImageService', true],
        ], [
            ...
            'vich_uploader.listener.clean.portfolio_image' => '?',
            'vich_uploader.listener.remove.portfolio_image' => '?',
            'vich_uploader.listener.upload.portfolio_image' => '?',
        ]), [[['preUpdate'], 'vich_uploader.listener.clean.portfolio_image'], [['postGenerateSchema'], 'doctrine.orm.messenger.doctrine_schema_listener'], [['onSchemaCreateTable'], 'doctrine.orm.messenger.doctrine_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.doctrine_dbal_cache_adapter_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.doctrine_token_provider_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.pdo_session_handler_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.lock_store_schema_listener'], [['loadClassMetadata'], 'doctrine.orm.default_listeners.attach_entity_listeners'], [['preRemove'], 'vich_uploader.listener.remove.portfolio_image'], [['postFlush'], 'vich_uploader.listener.remove.portfolio_image'], [['prePersist'], 'vich_uploader.listener.upload.portfolio_image'], [['preUpdate'], 'vich_uploader.listener.upload.portfolio_image']]);
    }
    ...
    protected static function getLocaleListenerService($container)
    {
        ...
        return $container->privates['locale_listener'] = new \Symfony\Component\HttpKernel\EventListener\LocaleListener(($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), 'en', $a, false, $container->parameters['kernel.enabled_locales']);
    }
    ...
    protected static function getTwigService($container)
    {
        ...
        $i->setEnabledLocales($container->parameters['kernel.enabled_locales']);
        ...
        $instance->addExtension(new \App\Twig\RtlExtension());
    ...
    private function getDynamicParameter(string $name)
    {
        ...
        $value = match ($name) {
            ...
            'notion_token' => $container->getEnv('NOTION_TOKEN'),
            'notion_database_id' => $container->getEnv('NOTION_DATABASE_ID'),
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.trusted_proxies' => '127.0.0.1,192.168.0.1/16',
            ...
            'vich_uploader.mappings' => [
                'portfolio_image' => [
                    ...
                    'upload_destination' => (\dirname(__DIR__, 4).'/public/images/portfolio'),
                    'namer' => [
                        'service' => 'Vich\\UploaderBundle\\Naming\\SmartUniqueNamer.portfolio_image',
                        'options' => [
