...
# Project Dossier
Served as Software Architect and NGO Technical Partner, designing and implementing a specialized, interactive B2C e-commerce platform for Arts-Mart. The implementation supported complex, multi-layered frontend asset customization.
