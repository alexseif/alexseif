...
# Project Dossier
Served as Software Architect and NGO Technical Partner, leading the technical transition from legacy setups into modern frameworks via a custom deployment of Symfony. The project involved re-engineering e-commerce software conventions to establish a user-centric wedding registry engine.
