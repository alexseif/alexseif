---
slug: 2021-saso
title: Saudi Ministry of Standards, Metrology and Quality (SASO)
year: 2021
client_name: Saudi Ministry of Standards, Metrology and Quality (SASO)
client_type: Public Sector — Federal
project_role: Technical Lead & Senior Software Engineer via iSoft
subtitle: Nationwide vehicle inspection and modification scheduling  platform managing
  multi-lane inspection facilities across  Saudi Arabia within strict 15-mi...
tech_stack:
- PHP
- JavaScript
- Drupal 8/9
- React
- Government-subsidized third-party hosting (pre-production simulation)
- MySQL
- 3NF Schema
- Star Schema
selected: true
