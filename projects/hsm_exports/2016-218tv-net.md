...
client_type: Outsourcing
project_role: Software Engineer
subtitle: Implemented a layout based on PSD's for this Drupal based website with high
  traffic. In addition to adding new features to Drupal.
tech_stack: []
selected: false
---
